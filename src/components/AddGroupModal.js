...
function AddGroupModal( { refreshGroupsList }) {
    ...
    return (
      <>
        <label htmlFor="add-group-modal" className="btn btn-primary">create new group</label>
        {/* Put this part before </body> tag */}
        <input ref={modalCheckRef} type="checkbox" id="add-group-modal" className="modal-toggle" />
        <div className="modal modal-bottom sm:modal-middle">
          <form className="modal-box" onSubmit={handleSubmit}>
            ...
            <div className="modal-action">
              ...
              <label >
                <button htmlFor="add-group-modal" className="btn btn-primary" type="submit">
                  Create Group
                </button>
              </label>
            </div>
